...
output_pins = [7,11,19,29,32,35,40]
C1 = [7,32]
C2 = [40,19]
C3 = [11,29,35]
C4 = [7,11,19]
...
while True:
    ...
    for result in results:   
        for box in result.boxes:
            ...
            if (nearest_object == 'person' or nearest_object == 'umbrella'): #C1
                GPIO.output(C1, GPIO.HIGH)
            elif (nearest_object == 'tv' or nearest_object == 'laptop'): #C2
                GPIO.output(C2, GPIO.HIGH)
            elif (nearest_object == 'dining table' or nearest_object == 'couch' or nearest_object == 'bench'): #C3
                GPIO.output(C3, GPIO.HIGH)
            elif (nearest_object == 'traffic light'): #C4
                GPIO.output(C4, GPIO.HIGH)
            elif (nearest_object == 'book'): #C5
                GPIO.output(C5, GPIO.HIGH)
            # elif (nearest_object == 'dog' or nearest_object == 'cat' or nearest_object == 'cow'): #35
            #     GPIO.output(output_pins[5], GPIO.HIGH)
            # elif (nearest_object == 'car'): #40
